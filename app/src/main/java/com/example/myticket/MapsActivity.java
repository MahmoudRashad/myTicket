...
import com.example.myticket.Model.MapModel.Geometry;
import com.example.myticket.Model.MapModel.NearByFullModel;
import com.example.myticket.Model.MapModel.Result;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, onResponceInterface {
    ...
    private void sendNetworkRequest(String latLng, int radius, String placeCinema, String keywordCinema, String apiKey) {
        ApiClient apiClient = new ApiClient(latLng,radius,placeCinema,keywordCinema,apiKey,this);
    ...
    private void locateNearByCinemas(NearByFullModel nearByFullModel) {
        ...
        for (int i = 0 ; i < results.size() ; i++){
            ...
            com.example.myticket.Model.MapModel.Location location = geometry.getLocation();
